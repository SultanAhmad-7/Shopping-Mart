...
<div class="span9">
	...
	<table class="table table-bordered">
              ...
              <tbody>
				  ...
				  @php
					  $attrPrice = Cart::getAttrPrice($cartItems['product_id'],$cartItems['size']);
				  @endphp
				  <tr>
					...
					<td>Rs.{{ $attrPrice * $cartItems['quantity'] }}</td>
				  </tr>
				  @php
						
						$totalPrice = $totalPrice + ($attrPrice * $cartItems['quantity']);
					@endphp
				  @endforeach
                ...
                <tr>
				 ...
				 <tr>
                  <td colspan="6" style="text-align:right"><strong>Grand TOTAL (Rs.{{ $totalPrice }} - Rs.0 + Rs.0) =</strong></td>
